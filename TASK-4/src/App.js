...
class App extends Component {
  ...
  deleteServer(id) {
    axios.delete('http://127.0.0.1:8080/servers/deleteServer?id=' + id).then((response) => {
      ...
      if (response.data == "Server has been deleted") {
        this.__refreshServersCollection();
        toast.success(response.data);
      } else {
      ...
      <div className="App container">
        ...
        <Modal isOpen={this.state.newServerModal} toggle={this.toggleNewServerModal.bind(this)}>
          ...
          <ModalBody>
            <FormGroup>
              ...
              <Input type="text" id="id" placeholder="Server ID eg 789" value={this.state.newServerObject.id} onChange={(e) =>{
            ...
            <FormGroup>
              ...
              <Input type="text" id="name" placeholder="Server Name eg. Hotspot" value={this.state.newServerObject.name} onChange={(e) =>{
                let {newServerObject} = this.state;
            ...
            <FormGroup>
              ...
              <Input type="text" id="language" placeholder="Programming Language eg. C++" value={this.state.newServerObject.language} onChange={(e) =>{
                let {newServerObject} = this.state;
            ...
            <FormGroup>
              ...
              <Input type="text" id="framework" placeholder="Framework eg. React" value={this.state.newServerObject.framework} onChange={(e) =>{
                let {newServerObject} = this.state;
        ...
        <footer class="container">
          <div class="column-left">
            <span>Praneeth Kumar (+91) 9765378112 </span> 
            <a href="https://www.linkedin.com/in/PraneethKumar/">     
          ...
          <div class="column-center">
            <p>
              <a href="mailto:PraneethKumar@gmail.com?Subject=Congratulations!" target="_top">praneethkumar@gmail.com </a>
              Fork here 
              <a href="https://github.com/PraneethKumar/kaiburr/">     
                <img alt="GitHub" src="https://avatars0.githubusercontent.com/u/9919?s=280&v=4" width="50" height="50" />
              </a>
            </p>
          </div>
          <div class="column-right">
            <p>Images are subject to copyright</p>
          </div>
        </footer>
      </div>
    );
